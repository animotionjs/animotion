...
<p>
	Svelte has a lot of great built-in tools for animations you can use but you can reach for any
	animation library like <a href="https://greensock.com/gsap/">GSAP</a> or
...
<p>
	I want to emphasize how <b>there is no right or wrong way</b> to do something. <b>Keynote</b> is
	only concerned about changing the slides and transitions between them and you can use
...
<p>
	If you have a more complicated example you can keep the code outside of the slides and show and
